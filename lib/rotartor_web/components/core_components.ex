defmodule RotartorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RotartorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RotartorWeb.Gettext, "errors", msg, opts)
    end
  end
